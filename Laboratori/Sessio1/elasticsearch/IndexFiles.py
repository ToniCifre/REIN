...
:Description: IndexFiles
    ...
    Indexes a set of files under the directory given as a parameter (--path)
    in the index name given as a parameter (--index)

    If the index exists it is dropped and created new

    The documents are created with a 'path' and a 'text' field
